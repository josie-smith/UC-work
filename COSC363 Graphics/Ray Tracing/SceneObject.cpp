...
glm::vec3 SceneObject::lighting(glm::vec3 lightPos, glm::vec3 viewVec, glm::vec3 hit)
{
	...
	diffuseTerm = glm::dot(lightVec, normalVec);
	if (spec_)
	{
	...
	glm::vec3 colorSum = ambientTerm*color_ + 0.5f*diffuseTerm*color_ + specularTerm*glm::vec3(1);
	return colorSum;
}
...
glm::vec3 SceneObject::lighting(glm::vec3 lightPos1, glm::vec3 lightPos2, glm::vec3 viewVec, glm::vec3 hit)
{
	...
	diffuseTerm1 = glm::dot(lightVec1, normalVec);
	diffuseTerm2 = glm::dot(lightVec2, normalVec);
	if (spec_)
	{
	...
	glm::vec3 colorSum = ambientTerm*color_ + diffuseTerm1*color_ + diffuseTerm2*color_ + specularTerm1*glm::vec3(1) + specularTerm2*glm::vec3(1);
	return colorSum;
}
